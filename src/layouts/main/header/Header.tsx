...
export default function Header() {
  ...
  return (
    <AppBar
      ...
      sx={{
        boxShadow: 'none',
        bgcolor: theme.palette.background.neutral, borderRadius: '5px'
      }}
    >
      <Toolbar
        disableGutters
          ...
          {isMdUp ? (
            ...
            openMenuMobile && (
              <MegaMenuMobile
                ...
                action={
                  <Button color="inherit" onClick={() => setOpenMenuMobile(true)}>
                    Categories
                  </Button>
                }
              />
            ...
            <Button variant="outlined" color="inherit" component={RouterLink} to={paths.auth.login}>
              Sign In
            </Button>
          </Stack>
