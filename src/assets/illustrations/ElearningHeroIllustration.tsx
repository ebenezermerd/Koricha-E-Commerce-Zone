  ...
  return (
    ...
    >
      ...
      >
        <Icon
          color={GREEN}
          iconContent={<Typography sx={{ ...styleIconContent }}>Dw</Typography>}
      ...
      <Box {...varRight} component={m.div} sx={{ zIndex: 8, bottom: 160, position: 'absolute' }}>
        <Icon
          color={YELLOW}
          iconContent={<Typography sx={{ ...styleIconContent }}>Ai</Typography>}
      ...
      <Box {...varUp} component={m.div} sx={{ zIndex: 8, right: 90, position: 'absolute' }}>
        <Icon
          color={PURPLE}
          iconContent={<Typography sx={{ ...styleIconContent, color: 'common.white' }}>Ae</Typography>}
      ...
      <Box {...varDown} component={m.div} sx={{ zIndex: 8, position: 'absolute' }}>
        <Icon
          color={BLUE}
          iconContent={<Typography sx={{ ...styleIconContent, color: 'common.white' }}>Ps</Typography>}
